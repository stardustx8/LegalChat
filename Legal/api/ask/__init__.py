...
5. **PENALTY INCLUSION** (RAG-Only): If ANY penalty, fine, criminal charge, imprisonment term, or legal consequence is mentioned in the provided CONTEXT, it MUST be included in the refined answer with full specificity. Include exact penalty ranges, imprisonment durations, fine amounts, and criminal classifications (e.g., "misdemeanours that can lead to fines or up to three years' imprisonment"). Legal consequences with their severity levels are always material to user decision-making.
6. **LEGAL CONSEQUENCES** (RAG-Only): If ANY legal consequences are mentioned in the provided CONTEXT, it MUST be included in the refined answer with full specificity. Include exact legal consequences, imprisonment durations, fine amounts, and criminal classifications (e.g., "misdemeanours that can lead to fines or up to three years' imprisonment"). Legal consequences with their severity levels are always material to user decision-making.
        ...
        drafter_system_message = """
{
  ...
  "workflow": [
    ...
    { "step": "salience_upgrade",
      "action": "From the kept passages extract every element that conditions legality:  \n                 • numeric thresholds (length, amount, age, time, penalty amounts, imprisonment duration, etc.)  \n                 • categorical qualifiers (e.g. "automatic", "concealed", "professional use")  \n                 • explicit exceptions / carve‑outs / special categories (e.g. butterfly knives, antique items)  \n                 • permit / licence or exemption regimes  \n                 • **DETAILED ENFORCEMENT AND PENALTY PROVISIONS**: Include specific penalty ranges, imprisonment terms, fine amounts, criminal classifications (misdemeanour/felony), and enforcement mechanisms  \n                 • age or capacity prerequisites explicitly stated in the text  \n                 • lawful‑tool / dangerous‑object clauses  \n                 Mark **each** item as MUST‑MENTION verbatim (units and durations included). **PENALTY INFORMATION WITH FULL SPECIFICITY IS ALWAYS RELEVANT AND MUST BE INCLUDED.**" },
    
    { "step": "penalty_completeness_check",
      "action": "MANDATORY: Review all provided passages for ANY mention of penalties, fines, criminal charges, imprisonment, confiscation, or legal consequences. Extract SPECIFIC penalty details including: fine amounts, imprisonment duration, criminal classification (misdemeanour/felony), enforcement mechanisms, and severity levels. If ANY penalty information exists in the context, it MUST be included in the answer with full specificity (e.g., 'fines or up to three years imprisonment'). Legal users need complete understanding of potential consequences and their severity." },
